...
def dataset_statistics(datadir: str = "data/raw", outputdir: str = "reports/figures") -> None:
    ...
    plt.savefig(os.path.join(outputdir, "mnist_images.png"))
    plt.close()
    ...
    plt.xlabel("Label")
    plt.ylabel("Count")
    plt.savefig(os.path.join(outputdir, "train_label_distribution.png"))
    plt.close()
    ...
    plt.xlabel("Label")
    plt.ylabel("Count")
    plt.savefig(os.path.join(outputdir, "test_label_distribution.png"))
    plt.close()
